...
public interface GraphUser extends GraphObject {
    ...
    /**
     * Returns the current friends of the user.
     * @return the current friends of the user
     */
    public Map<String, GraphFriend> getFriends();
    /**
     * Sets the current friends of the user.
     * @param location the current friends of the user
     */
    public void setFriends(Map<String, GraphFriend> friends);
    
    /**
     * Returns the current friends of the user.
     * @return the current friends of the user
     */
    public Map<String, GraphFriend> getFriendsOfFriends();
    /**
     * Sets the current friends of the user.
     * @param location the current friends of the user
     */
    public void setFriendsOfFriends(Map<String, GraphFriend> friends);
}
